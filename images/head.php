      ...
      <div class="row no-gutters">
        ...
        <div class="col-lg-8 text-center text-lg-right">
          ...
          <?php  if(!isset($_SESSION['Username'])) { ?>
            <li class="list-inline-item"><a class="text-uppercase text-white p-sm-2 py-2 px-0 d-inline-block" href="login.php" >login</a></li>
            <li class="list-inline-item"><a class="text-uppercase text-white p-sm-2 py-2 px-0 d-inline-block" href="index.php" >register</a></li>
            <li class="list-inline-item"><img style="border-radius:100%;" src="images/pro.jpg" alt="profile" height="30" width="30"></li>
          <?php  } else { ?>
